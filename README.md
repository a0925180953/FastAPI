...
<<<<<<< HEAD
> **專案小助手提示**: 您好！我是您的專案開發助手。這份文件會帶您快速了解這個專案的架構與功能！
=======
> **專案提示**: 這份文件會帶你快速了解這個超酷的專案！
>>>>>>> 35c62129a99697e5702c092dedf1b2aff1da0de3
...
2. **AI 回覆**:
<<<<<<< HEAD
   - 若 AI API 額度不足或發生異常，系統將統一回覆：「AI 目前額度不足，請稍後再試，或聯繫系統管理員。」。
=======
   - 若 AI API 額度不足或發生異常，系統將統一回覆指定訊息。
>>>>>>> 35c62129a99697e5702c092dedf1b2aff1da0de3
3. **資料庫異動**:
